...
- **Pendiente:** integración con memoria narrativa (sugerir/registrar consecuencia al terminar combate, #F5-05); reacciones/ataques de oportunidad narrativos, flanqueo narrativo (preparado en docs, sin implementar, #F5-05/#F5-07).
- **P.** P1.
...
- **Pendiente:** ataques completos con tirada contra CA (#F5-03, ya hecho); aplicar de verdad flanqueo narrativo y la confirmación de reacciones/ataques de oportunidad propuestos (#F5-05/#F5-07); sorpresa.
- **P.** P1.
...
- **Pendiente:** IA enemiga / selección automática de acciones; ventaja/desventaja (#F5-04, ya hecho); reacciones/ataques de oportunidad/flanqueo mecánicos (#F5-05); cobertura, áreas de efecto, resistencias/vulnerabilidades, salvaciones, hechizos.
- **P.** P1.
...
- **Pendiente:** críticos más ricos (rangos de amenaza ampliados, daño extra por clase, #F5-08); acumulación de múltiples ventajas/desventajas si llega a hacer falta; flanqueo/cobertura que conceda ventaja/desventaja automáticamente (#F5-05/#F5-07).
- **P.** P1.
### #F5-05 — Acciones del turno y propuesta de reacción ("el agente propone, el jugador confirma")
### #F5-06 — Skill `dirigir-combate`
### #F5-07 — Reglas básicas más ricas (condiciones, salvaciones, flanqueo/cobertura automáticos) — solo si D17 lo justifica
### #F5-08 — Críticos más ricos (rangos de amenaza ampliados, daño extra por rasgo de clase)
### #F5-09 — Fixtures: enemigos low-level reutilizables
- **P.** P1.
